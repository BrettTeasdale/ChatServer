defmodule ChatServerWeb.ChatLive.ChannelCreateModalComponent do
  ...
  def update(assigns, socket) do
    socket =
      ...
      |> assign(:server_user, assigns.server_user)
  ...
  def handle_event("save", %{"channel" => channel_params}, socket) do
    case Servers.create_channel(socket.assigns.server_user, channel_params) do
      {:ok, channel} ->
        Servers.channel_list_broadcast(
          socket.assigns.current_user.id,
          socket.assigns.server_user.server_id,
